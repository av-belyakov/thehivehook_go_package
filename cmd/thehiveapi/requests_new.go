...
func (api *TheHiveApi_New) GetObservables(ctx context.Context, rootId string) ([]byte, int, error) {
...
func (api *TheHiveApi_New) GetTTP(ctx context.Context, rootId string) ([]byte, int, error) {
	req, err := json.Marshal(&Querys{
		Query: []Query{
			{Name: "getCase", IDOrName: rootId},
			{Name: "procedures"},
...
// основой Case
func (api *TheHiveApi_New) GetCaseEvent(ctx context.Context, rootId string) ([]byte, int, error) {
	req, err := json.Marshal(&Querys{
		Query: []Query{
			{Name: "getCase", IDOrName: rootId},
		},
...
func (api *TheHiveApi_New) AddCaseTask(ctx context.Context, rc RequestCommand) ([]byte, int, error) {
	var req []byte
	if rc.Username == "" {
...
func (api *TheHiveApi_New) query(ctx context.Context, reqpath string, query []byte, method string) ([]byte, int, error) {
	var (
		res *http.Response
		err error
	)
