...
#### Переменные окружения отвечающие за временное хранения объектов

- **GO_HIVEHOOK_TSTORAGEOBJECTTTL** - время жизни объектов в хранилище, в секундах 10 до 43200 секунд (12 часов)
- **GO_HIVEHOOK_TSTORAGDELAYTOSENDCASE** - время по истечении которого объект '_case_' из записи будет передан в канал, а сама запись будет удалена, допустимый интервал от 1 до 600 секунд (от 1 секунды до 10 минут)
- **GO_HIVEHOOK_TSTORAGDELAYTOSENDALERT** - время по истечении которого объект '_alert_' из записи будет передан в канал, а сама запись будет удалена, допустимый интервал от 1 до 600 секунд (от 1 секунды до 10 минут)
...
полный пример с endpoints для ГЦМ
